        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-sans font-bold tracking-tight mb-6 leading-[1.2] text-white drop-shadow-lg" style={{ color: 'white' }}>
              ...
              <span className="text-xl md:text-2xl lg:text-3xl font-normal">with</span><br />
              <span className="font-extrabold text-xl md:text-3xl lg:text-4xl">HYBRID INTELLIGENCE</span>
            </h1>
